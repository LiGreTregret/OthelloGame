...
class TestModeSelector:
    def t_set_player(self):
        ...
        first_player = mode_selector_context.mode_selector.player_manager_context.player_manager.first_player
        second_player = mode_selector_context.mode_selector.player_manager_context.player_manager.second_player
